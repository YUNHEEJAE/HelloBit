...
<!-- 								<i class="fa fa-circle-o"></i> python v2</a></li> -->
					...
					<li class="treeview" id="faculity_2"><a href="#"> <i
							class="fa fa-dashboard"></i> <span>학원 관리</span> <span
						...
						<ul class="treeview-menu">
<!-- 						active 오또오또케 -->
							<li class=""  id="faculity_list"><a href="list"><i
									class="fa fa-circle-o"></i>학생 교직원 교실 관리</a>
							</li>
							<li class="" id="faculity_takeprogramlist"><a href="takeprogramlist"><i class="fa fa-circle-o"></i>
									수강 현황 관리</a></li>
						</ul></li>
