	...
	<div class="content-wrapper" style="min-height: 976px;">
		...
		<div class="row">
			...
			<div class="form-group">
				  <label class=" control-label" >과목명</label>  
				  <input id="pcourse" name="subname" type="text" placeholder="과목명" class="form-control">
				...
				<div class="form-group">
				  ...
				  <input id="pcourse" name="subgrade" type="text" placeholder="등급"  class="form-control">
					<span class="help-block">It identify how many days it takes for deliver</span>  
				</div>
